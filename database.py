...
CREATE TABLE IF NOT EXISTS results (
    ...
    EndoscopyNLP INTEGER,
    EndoscopyInformationNLP TEXT,
    NumberOfDuodenalBiopsiesNLP INTEGER,
    DuodenalBiopsiesTakenNLP INTEGER,
    ...
    EndoscopyLLM INTEGER,
    EndoscopyInformationLLM TEXT,
    NumberOfDuodenalBiopsiesLLM INTEGER,
    DuodenalBiopsiesTakenLLM INTEGER,
