...
from database import create_db, ingest_csv, safe_export_combined_results_to_csv, safe_export_all_tables_combined_to_csv
...
def main():
    ...
    try:
        if args.analyze:
            ...
            safe_export_all_tables_combined_to_csv()
        elif args.print:
